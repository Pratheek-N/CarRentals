...
<body>
    ...
    <section class="latest-cars">
        <div class="container1">
            <h2 class="text-center">Search results for "<?php echo  $search ?>"</h2>
            <div id="sec2">
                      <br>
                      <section class="menu-content">
                <?php  
                
                $sql="select * from cars where status=1 and car_name like'%$search%' or brand_id like'%$search%' or type_id like'%$search%'";
